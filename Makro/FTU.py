from Makro.CryptographyKit.utils import _gen_safe_password
from Makro.src import FTU_Installer as ftu_install
from Makro.CryptographyKit import EncryptPassword
from Makro.utils import clear_screen, edit_user_config
from Makro.RendererKit import Renderer as RD
from Makro import flags, SNC, utils
import os, re
        ...
        if self.edit_use:
            ...
            while not apply_done:
                if os.path.isfile(f'{flags.base_folder}/users/{self.username}.json'):
                    ...
                    from Makro.src import Recover_Json
