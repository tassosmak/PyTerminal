...
class Game:
    ...
    def update(self):
        ...
        for hit in hits:
            if self.player.weapon == 'pistol':
                ...
                hit.health -= BULLET_DAMAGE_SNIPER
            hit.vel = vec(0, 0)
    ...
    def draw(self):
        ...
        if self.player.weapon == 'pistol':
            self.draw_text("Pistol", self.title_font, 20, WHITE, WIDTH - 50, 10, align="center")
        elif self.player.weapon == 'sniper':
            self.draw_text("Sniper", self.title_font, 20, RED, WIDTH - 50, 10, align="center")
        pg.display.flip()
